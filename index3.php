...
if(empty($_SESSION['SPV Purchasing'])){
...
<body id="page-top">
 ...
 <?php
   if ($_SESSION['SPV Purchasing']) {
	   $user = $_SESSION['SPV Purchasing'];
   }
    ...
    <li class="d-flex align-items-center justify-content-center">
      ...
      <div class="sidebar-heading">
        Laporan
	     ...
	     <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLaporanMaster" aria-expanded="true" aria-controls="collapseLaporanMaster">
          <i class="fas fa-fw fa-folder"></i>
          <span>Laporan Daftar Master</span>
        </a>
        <div id="collapseLaporanMaster" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu :</h6>
       ...
       <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLaporanTrans" aria-expanded="true" aria-controls="collapseLaporanTrans">
          <i class="fas fa-fw fa-folder"></i>
          <span>Daftar Transaksi</span>
        </a>
        <div id="collapseLaporanTrans" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu :</h6>
            ...
            <a class="collapse-item" href="?page=laporan&aksi=laporan_keluar">Laporan Daftar Keluar</a>
            <a class="collapse-item" href="?page=laporan_masuk">Laporan Daftar Masuk</a> 
          </div>
        </div>
       </li>
       ...
       <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLaporanRekap" aria-expanded="true" aria-controls="collapseLaporanRekap">
          <i class="fas fa-fw fa-folder"></i>
          <span>Laporan Rekapitulasi</span>
        </a>
        <div id="collapseLaporanRekap" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu :</h6>
            <a class="collapse-item" href="?page=laporan/laporan_rekap_barang_masuk">Laporan Rekap Masuk</a>
            <a class="collapse-item" href="?page=laporan&aksi=rekapkeluar">Laporan Rekap Keluar</a>
            <a class="collapse-item" href="?page=laporan/laporan_rekap_belanja">Laporan Rekap Belanja</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
         ...
         if ($aksi == "tampildetail") {
            include "page/belanja/tampildetail.php";
         }
        }
         if ($page == "rab") {
          if ($aksi == "") {
          ...
          if ($aksi == "tampildetail") {
            include "page/rab/tampildetail.php";
         }
        }
           ...
           if ($aksi == "tampildetail") {
            include "page/barangmasuk/tampildetail.php";
         }
			   }
          ...
          if ($aksi == "tampildetail") {
            include "page/barangkeluar/tampildetail.php";
         }
       }
        ...
        if ($page == "laporan") {
          if ($aksi == "rekapkeluar") {
            include "page/laporan/laporan_rekap_barang_keluar.php";
          }
          if ($aksi == "laporan_keluar") {
             include "page/laporan/laporan_barang_keluar.php";
          }
        }
